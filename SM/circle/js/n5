    ...
    "Ур. 01" : 
            [
                {   
                    ...
                    "kunyomi" : "ひと-, ひと.つ",
                    "definition" : "Один",
                    "examples" : ["一 ひとつ один, одна вещь, лишь это","一握り ひとにぎり пригоршня","一員 いちいん один из членов (клуба, общества...)"]
                },{
                    "kanji" : "ニ",
                    "onyomi" : "ニ, ジ",
                    "kunyomi" : "ふた, ふた.つ, ふたた.び",
                    "definition" : "Два",
                    "examples" : ["二男 じなん второй сын","二子 ふたご близнец(ы)","二月　にがつ февраль"]
                },{
                    "kanji" : "三",
                    "onyomi" : "サン, ゾウ",
                    "kunyomi" : "み, み.つ, みっ.つ",
