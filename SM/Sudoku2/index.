...
<html lang="en">
  ...
  <body>
	...
	<?php if( !isset($_GET['embed']) || !$_GET['embed'] ): ?><div id="contents">
		<h4>Как играть</h4>
<ul><li>Листайте влево-вправо в меню сверху для смены уровня сложности игры.</li>
<li>Нажмите Играть</li>
<li>Используйте кнопки с цифрами, чтобы помещать их на поле игры.</li>
<li>Вебери число два раза, чтобы увидеть варианты.</li>
</ul>
В таблице ты можешь:

<ul><li>Левая мышь: поместить/убрать число.</li>
<li>Средняя мышь или Ctrl + Left Click : поместить догадку на поле</li>
<li>Правая мышь: удалить число</li>
	</div><?php endif; ?>
	...
	;(function($, window, document, undefined){
		$.Sudoku = function(game){
			...
			var level_label = ['Новичок','Легко','Приемлемо','Тёртый калач', '17 подсказок'];
