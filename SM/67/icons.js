...
const APPS = [
  ...
  /*  {
    ...
    }, */
    {
        ...
        get icon() {
            ...
            return '<svg width="2.1em" height="2.1em" viewBox="0 0 24 24"><title xmlns="">calendar</title><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M17.25 4.75H6.75a3.5 3.5 0 0 0-3.5 3.5v9.5a3.5 3.5 0 0 0 3.5 3.5h10.5a3.5 3.5 0 0 0 3.5-3.5v-9.5a3.5 3.5 0 0 0-3.5-3.5m-14 4.5h17.5M7.361 4.75v-2m9.25 2v-2"/></svg><text x="16" y="26" font-size="14" text-anchor="middle" fill="black" stroke="none">' + date + '</text>';
        }
    },
    {
        id: 'contacts',
  ...
  /*  {
    ...
    },
    {
        ...
        name: 'Notes',
        cat: 'tools',
        icon: '<svg width="2em" height="2em" viewBox="0 0 48 48"><title xmlns="">notes</title><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M5.5 9.5v22.9h10.1v10.1h22.9c2.2 0 4-1.8 4-4v-29c0-2.2-1.8-4-4-4h-29c-2.2 0-4 1.8-4 4m0 22.9l10.1 10.1"/></svg>'
    },
    {
        id: 'journal',
        name: 'Journal',
  ...
  /*  {
   ...
   /* {
    ...
    },
    {
        ...
        name: 'Habit Tracker',
        cat: 'lifestyle',
        icon: '<svg width="2em" height="2em" viewBox="0 0 48 48"><title xmlns="">delta-investmenttracker</title><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" d="M42.422 38.954H5.578L24 7.046z"/></svg>'
    },
   /* {
        id: 'life',
        name: 'Life Calendar',
    ...
    },
    {
        ...
        name: 'Books',
        cat: 'lifestyle',
        icon: '<svg width="2em" height="2em" viewBox="0 0 24 24"><title xmlns="">book-stack</title><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-width="1.5"><path d="M5 19.5V5a2 2 0 0 1 2-2h11.4a.6.6 0 0 1 .6.6V21M9 7h6m-8.5 8H19M6.5 18H19M6.5 21H19"/><path stroke-linejoin="round" d="M6.5 18c-1 0-1.5-.672-1.5-1.5S5.5 15 6.5 15m0 6c-1 0-1.5-.672-1.5-1.5S5.5 18 6.5 18"/></g></svg>'
    },
   /* {
        id: 'watchlist',
        name: 'Watchlist',
  ...
  /*  {
   ...
   /* {
    ...
    },
    {
        ...
        cat: 'games',
        desc: 'Rip and Tear',
        // Official Doom logo vector from user provided file (Doom_–_Game’s_logo.png)
