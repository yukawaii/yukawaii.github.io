...
function getinfo1(){
    ...
    bridge.send("VKWebAppCallAPIMethod", {"method": "apps.getScore", "request_id": "getscore", "params": {"user_id": userid, "v":5.1, "access_token":token, global:1}})
...
function sendscore1(){
    getinfo1();
    bridge.send("VKWebAppCallAPIMethod", {"method": "secure.addappEvent", "request_id": "appevent_from_script", "params": {"client_secret":"qp47UOdcqJmW94rKknxR","user_id": userid, "activity_id":2, "value": score1, "v": "5.1", "access_token": token}})
