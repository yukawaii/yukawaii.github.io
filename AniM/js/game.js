(function() {
  ...
  Game.prototype.setScore = function(){
    $(".score").html("Очки:" + " " + this.board.score);
  };
  ...
  Game.prototype.win = function(){
    var modal = ("<div class='modal-text'><p>Это победа!! <br> Сможешь повторить?</p><div class='modal-button'><button>Играть ещё раз</button></div></div></div>");
    $(".modal").html(modal);
    $(".modal-button").on("click", this.newGame.bind(this));
  };

  Game.prototype.lose = function(){
    var modal = ("<div class='modal-text'><p>Игра окончена. <br> Набрано очков: " + this.board.score + ". <br> Сыграем ещё?</p><div class='modal-button'><button>Играть ещё</button></div></div></div>");
    $(".modal").html(modal);
    $(".modal-button").on("click", this.newGame.bind(this));
  };
