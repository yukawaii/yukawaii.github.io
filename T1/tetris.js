...
function drawPausedScreen(){
    ...
    context.fillText("Нажмите пробел или коснитесь, чтобы продолжить", canvas.width /2, canvas.height /1.8)
...
function drawMainMenu(){
    ...
    context.font = '18px Russo One';
    context.fillText("Нажмите пробел или коснитесь, чтобы начать", canvas.width /2, canvas.height /1.8)
}
