  ...
  candlestick.position.set(130, 20, 360);
  ...
  telepfone.position.set(40, -140, 200);
  ...
  oil_lamp.rotation.set(1.1, 1.4, 2);
  scene.add(oil_lamp);
  ...
  clock.position.set(160, -205, 280);
  ...
  var bat = new THREE.Mesh(new THREE.PlaneGeometry(100, 100), img_bat);
  bat.name = 'ネズミ';
  bat.position.x = 210;
  bat.position.y = 100;
  bat.position.z = -290;
  ...
  var old_frame = new THREE.Mesh(new THREE.PlaneGeometry(100, 100), img_old_frame);
  old_frame.name = '家';
  old_frame.position.x = 50;
  old_frame.position.y = 20;
  old_frame.position.z = -400;
